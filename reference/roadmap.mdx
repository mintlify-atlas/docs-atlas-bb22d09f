---
title: "Course Roadmap: 260+ Lessons Across 20 Phases"
description: "Full progress tracker for all 20 phases and 260+ lessons — from setup and math foundations to autonomous agent swarms and capstone projects."
keywords: ["AI course roadmap", "AI engineering curriculum", "course progress", "lesson plan", "AI learning path"]
---

The complete curriculum spans 20 phases and 260+ lessons at an estimated ~290 hours of learning. Phases build on each other: math before neural networks, neural networks before transformers, transformers before LLMs, LLMs before agents. Every phase ends with a capstone or substantial project.

**Legend:** ✅ Complete | 🚧 In Progress | ⬚ Planned

<Note>
96 lessons are complete. The remaining phases are community-driven — see [Contributing](/reference/contributing) to help finish them. Pick any ⬚ lesson and submit a PR.
</Note>

## Summary

| Phase | Name | Lessons | Est. Hours | Status |
|-------|------|---------|------------|--------|
| 0 | Setup & Tooling | 12 | ~14 hrs | ✅ |
| 1 | Math Foundations | 22 | ~23 hrs | ✅ |
| 2 | ML Fundamentals | 18 | ~21 hrs | ✅ |
| 3 | Deep Learning Core | 13 | ~15 hrs | ✅ |
| 4 | Computer Vision | 16 | ~19 hrs | ⬚ |
| 5 | NLP — Foundations to Advanced | 18 | ~19 hrs | ⬚ |
| 6 | Speech & Audio | 12 | ~13 hrs | ⬚ |
| 7 | Transformers Deep Dive | 14 | ~14 hrs | 🚧 |
| 8 | Generative AI | 14 | ~14 hrs | ⬚ |
| 9 | Reinforcement Learning | 12 | ~13 hrs | ⬚ |
| 10 | LLMs from Scratch | 14 | ~18 hrs | 🚧 |
| 11 | LLM Engineering | 13 | ~15 hrs | ✅ |
| 12 | Multimodal AI | 11 | ~11 hrs | ⬚ |
| 13 | Tools & Protocols | 10 | ~11 hrs | ⬚ |
| 14 | Agent Engineering | 15 | ~17 hrs | 🚧 |
| 15 | Autonomous Systems | 11 | ~11 hrs | ⬚ |
| 16 | Multi-Agent & Swarms | 14 | ~15 hrs | 🚧 |
| 17 | Infrastructure & Production | 11 | ~13 hrs | 🚧 |
| 18 | Ethics, Safety & Alignment | 6 | ~5 hrs | ⬚ |
| 19 | Capstone Projects | 5 | ~10 hrs | ⬚ |

**Total: 20 phases · 260+ lessons · ~290 hours**
...
Want to help finish the remaining phases? See [Contributing](/reference/contributing) to learn how to add a lesson, submit a PR, or add outputs to completed lessons.
